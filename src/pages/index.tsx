...
export default function Home({ latestEpisodes, allEpisodes }: HomeProps) {
  ...
  const dataFormated = data.episodes.map(episode => {
    return {
      id: episode.id,
      title: episode.title,
  ...
  const latest = dataFormated.slice(0, 2)
  const all = dataFormated.slice(2, dataFormated.length)
...
//     }
//   })
//   // Formatar os dados antes de renderizar os componentes da tela
